...
*   **Microcontrollers:** STM32F446RE (Node Main), STM32F407VG (Node Airbag), STM32F103C8T6 (Node ABS).
*   **Protocol:** High-speed CAN 2.0A at 500 kbps.
...
*   Implemented a strict 2.5g collision threshold to accurately differentiate between real impacts and normal driving vibrations.
